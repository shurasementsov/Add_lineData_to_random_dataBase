...
/*postgres-# */ AND (information_schema.key_column_usage.table_name = 'reys' OR information_schema.constraint_column_usage.table_name = 'reys') 
...
-----------------+--------------+-------------+------------------
 ...
 sector_reys_fk  | sector       | reys_id     | reys
(6 rows)
